...
STOW_FOLDERS="btop dunst hypr kitty nvim rofi waybar wofi gtk thunar yazi wal wpg zsh kanshi zellij scripts qt lazygit cava nwg onlyoffice obs-studio zathura zen-browser"
